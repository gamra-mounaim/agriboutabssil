                        ...
                        <tr>
                            ...
                            <td style={{ textAlign: isRTL ? 'left' : 'right' }}>
                                <div className="space-y-1 font-mono text-sm">
                                    <p>Facture #: <span className="font-bold text-slate-950">{sale.invoiceNumber ? sale.invoiceNumber.toString().padStart(6, '0') : (sale.id?.slice(-8).toUpperCase() || 'PROV-' + Date.now().toString().slice(-4))}</span></p>
