...
export default function SupplierList({ suppliers, checks, user, settings, setMessage, language, onRefresh, permissions }: { suppliers: Supplier[], checks: CheckDoc[], user: any, settings: any, setMessage: (m: { text: string, type: 'success' | 'error' }) => void, language: Language, onRefresh: () => void, permissions?: any }) {
